    ...
    <div id="wrapper">
        ...
        <body>
			...
			<?php
				...
				{
					$pais = $_POST["pais"];
					$result = pg_query("DELETE FROM equipa WHERE id_equipa='".$pais."';");
				...
				if(isset($_POST['nome'])){
					$nome = $_POST["nome"];
					$result = pg_query("DELETE FROM jogadores WHERE id_jogador='".$nome."';");
					if ($result!=false)
						echo "DELETE OK!";
					else
						echo "NOT DELETE";
				...
				if(isset($_POST['id_jogo'])){
					...
					$result = pg_query("DELETE FROM jogos WHERE id_jogo='".$id_jogo."';");
					if ($result!=false)
						echo "DELETE OK!";
					else
						echo "NOT DELETE";
				...
				if(isset($_POST['id_jogador'])){
					...
					$result = pg_query("DELETE FROM golos WHERE id_jogador='".$id_jogador."';");
				if ($result!=false)
						echo "DELETE OK!";
					else
						echo "NOT DELETE";
