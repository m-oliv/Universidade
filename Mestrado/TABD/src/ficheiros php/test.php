    ...
    <div id="wrapper">
        ...
        <body>
			<div id="core" class="clearfix">
				...
				<form class="pure-form" action="testnext.php" method="post">
					<label for="option-two" class="pure-radio" >
						<input id="option-two" type="radio" name="tabela" value="pesquisar" >
						Pesquisar<br><br>
						<input id="option-two" type="radio" name="tabela" value="inserir">
						Inserir<br><br>
						<input id="option-two" type="radio" name="tabela" value="atualizar">
						Atualiziar<br><br>
						<input id="option-two" type="radio" name="tabela" value="eliminar">
						Eliminar<br><br>
						<!--<input id="option-two" type="radio" name="tabela" value="estatisticas">
						Estatisticas<br><br>!-->
